...
namespace App\ConnectionPools\Route;


class RouteService
{
    const HINT_SPLIT = '=';
    const PROXY_HINT_TYPE = "_proxyHintType";
    ...
    private static function parseKeyValue(array &$arr, string $substring)
    {
        ...
        if ($indexOf != -1) {
            ...
            if (\App\ConnectionPools\Common\endsWith($value, "'") && \App\ConnectionPools\Common\startsWith($value, "'")) {
